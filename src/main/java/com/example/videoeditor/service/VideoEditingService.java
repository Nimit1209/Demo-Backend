...
public class VideoEditingService {
    ...
    private final String ffmpegPath = "D:\\ffmpeg-2025-02-17-git-b92577405b-full_build\\bin\\ffmpeg.exe";
    private final String baseDir = "D:\\VideoEditor-main"; // Base directory constant
    private final String ELEMENTS_DIR = "D:\\VideoEditor-main\\elements\\";
